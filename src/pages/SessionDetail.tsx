          ...
          <div className="bg-white p-6 rounded-3xl border border-brand-border modern-shadow-sm">
            ...
            <div className="pt-6 border-t border-brand-border space-y-3">
              <button 
                ...
                className="w-full flex items-center justify-center gap-3 py-4 bg-emerald-600 text-white rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-emerald-700 transition-all modern-shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
              >
                <UserPlus size={16} />
              ...
              {session.status?.toLowerCase() === 'active' && (
                <button 
                  ...
                  className="w-full flex items-center justify-center gap-3 py-4 bg-rose-600 text-white rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-rose-700 transition-all modern-shadow-lg"
                >
